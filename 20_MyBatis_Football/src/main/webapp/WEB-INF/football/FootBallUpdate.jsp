...
<script>
	$(document).ready(function(){
		...
		$('#name_check').click(function(){		//중복체크 클릭 시
...
<body onLoad="init('${football.league}','${football.team}')">
	...
	<form:form commandName="football" name="myform" action="update.fb" method="post">
		<h2>선수 정보 수정</h2>
		...
		<table border="1" align="center" width="50%" height="60%">
			<tr>
				<th>선수이름</th>
				<td>
					<input type="hidden" name="num" value="${football.num}">
			...
			<tr>
				<th>키</th>
				<td>
					<input type="text" name="height" value="${football.height}">
					<input type="text" value="cm" size="2" disabled >
			...
			<tr>
				<th>몸무게</th>
				<td>
					<input type="text" name="weight" value="${football.weight}">
					<input type="text" value="kg" size="2" disabled >
